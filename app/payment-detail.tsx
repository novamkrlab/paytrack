...
export default function PaymentDetailScreen() {
  ...
  const handleDelete = () => {
    ...
    if (relatedPayments.length > 0) {
      ...
      // Tekrarlanan ödeme mi kontrol et (otomatik oluşturulmuş)
      const isRecurring = payment.recurrence || payment.autoGenerated;
      ...
      if ((isInstallment || isRecurring) && futurePayments.length > 0) {
        buttons.push({
