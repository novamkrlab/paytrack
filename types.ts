...
export interface Income {
  ...
  recurrence?: {
    frequency: RecurrenceFrequency;
    nextDate?: string; // Bir sonraki otomatik oluşturma tarihi
    repeatCount?: number; // Kaç kez tekrarlanacak (opsiyonel, boşsa süresiz)
    endDate?: string; // Tekrarlamayı durdurma tarihi (opsiyonel)
  };
  notes?: string;
  autoGenerated?: boolean; // Otomatik oluşturuldu mu?
  createdAt: string;
